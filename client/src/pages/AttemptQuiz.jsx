...
const AttemptQuiz = () => {
    ...
    return (
        <section className=' min-h-[90vh] py-10'>
            <div className='border py-3 px-5 rounded-lg bg-slate-900 border-slate-600  bg-gradient-to-r from-blue-200 to-blue-300 '>
                {
                    questionsLoading || detailsLoading ? <h1>Loading...</h1> :
                        <>
                            <span className='flex flex-col md:flex-row gap-x-5 gap-y-1 items-center justify-between font-thin mb-3 text-black'>
                                <h3 className='text-base md:text-2xl font-semibold line-clamp-2 text-black'>{quizDetails?.title}</h3>
                                <p className='text-slate-300 w-fit text-nowrap text-black'>Time : {quizDetails?.timer} minutes</p>
                            </span>
                            <span className='flex flex-col md:flex-row justify-between items-center gap-x-5 gap-y-1 font-thin text-black'>
                                <p className='font-thin mt-1 line-clamp-2 text-black'>{quizDetails?.description} </p>
                                <span className='flex gap-3 text-slate-300 w-fit text-nowrap text-black'>
