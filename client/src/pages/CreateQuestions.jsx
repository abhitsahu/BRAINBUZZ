...
const CreateQuestions = () => {
    ...
    return (
        <>
            <div className='relative flex justify-start flex-col items-center gap-5 py-10 border-2 border-gray-300'>
                <div>
                    <h3 className='text-3xl underline text-center '>Add Questions</h3>
                </div>

                <section className='flex gap-y-3 w-full flex-col md:flex-row justify-between items-center  border-2 border-gray-300'>
                ...
                <div className='w-full flex flex-col gap-5 rounded-lg min-h-[50vh]  border-2 border-gray-300'>
                    {
