...
const DashboardLayout = ({ children }) => {
    ...
    return (
        <section className=''>
            <div className='flex py-3 px-3 justify-between items-center gap-y-5  my-3 text-lg bg-slate-900 rounded-lg border border-slate-600  bg-gradient-to-r from-blue-200 to-blue-300'>
