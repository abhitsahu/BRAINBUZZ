...
const QuizQuestions = ({ quizDetails, quizQuestions }) => {
    ...
    return (
        <div className='flex py-5 border min-h-[70vh] px-5 justify-center items-start mt-5 rounded-lg bg-slate-900 border-slate-600 bg-gradient-to-r from-blue-200 to-blue-300'>
            {!quizStarted ? (
