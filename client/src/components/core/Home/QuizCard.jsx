...
const QuizCard = ({ quiz }) => {
    ...
    return (
        <Link to={`/quiz/${quiz._id}`} className='border border-slate-600 bg-slate-900 p-3 rounded-lg relative overflow-hidden  bg-gradient-to-r from-blue-200 to-blue-300'>
