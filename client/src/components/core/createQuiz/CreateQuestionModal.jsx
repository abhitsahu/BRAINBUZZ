...
const CreateQuestionModal = ({ quiz, setQuestions, setCreateQuestionModalData }) => {
  ...
  return (
    <div className='absolute top-[50%] max-w-[480px] mx-auto translate-y-[-50%] flex justify-start p-5 gap-10 flex-col items-center bg-slate-800 shadow-lg shadow-slate-600 rounded-lg border border-slate-600 inset-0 h-max text-white'>
      <h3 className='text-3xl text-white'>Create a question</h3>
