...
const QuizCard = ({ quiz, handleDeleteQuiz }) => {
    ...
    return (
        <>
            <div className='py-3 px-5 border border-slate-600 bg-slate-900 hover:border-slate-400 transition-all duration-300 rounded-lg relative  bg-gradient-to-r from-blue-200 to-blue-300'>
